...
- [ ] **Next up:** Phase 1 closes with P1.7d part 2 (pane-targeted spawns) and P1.9b. Phase 2 is split into P2.1–P2.10 and under way (P2.2 done). Phase 1 items P1.1–P1.6, P1.7a–c, P1.7d part 1, P1.8, P1.9 and P1.10a–e are done. See [native-client.md](./plans/native-client.md) for the full list
