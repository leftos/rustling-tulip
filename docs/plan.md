...
- [ ] **Next up:** Phase 1, continuing at P1.7d (shells and empty-pane spawn) and P1.8 (quit flow), then P1.10d. P1.1–P1.6, P1.7a–c, P1.9 and P1.10a–e are done. See [native-client.md](./plans/native-client.md) for the full list
