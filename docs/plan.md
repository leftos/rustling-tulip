...
- [ ] **Next up:** Phase 1, continuing at P1.7c-B (spawn dialog), then P1.7c-C, P1.7d, P1.9, P1.10d and P1.8. P1.1–P1.6, P1.7a, P1.7a2, P1.7b, P1.7c-A and P1.10a–e are done. See [native-client.md](./plans/native-client.md) for the full list
