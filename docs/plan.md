...
- [ ] **Next up:** Phase 1, continuing at P1.10a (in-process UI specs), then P1.7 and P1.10b. P1.1–P1.6 are done. See [native-client.md](./plans/native-client.md) for the full list
