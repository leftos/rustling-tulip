...
- [ ] **Next up:** finish Phase 2 with P2.10b (the appearance editor), then Phase 3 (source control): P3.3 is next, and P3.1, P3.2 and P3.9 are done. Phases 1 and 2 (except P2.10b) are complete. See [native-client.md](./plans/native-client.md) for the items and their decided designs.
