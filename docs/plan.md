...
- [ ] **Next up:** Phase 1, continuing at P1.10 (UI test harness; its design step comes first), then P1.7. P1.1–P1.6 are done. See [native-client.md](./plans/native-client.md) for the full list
