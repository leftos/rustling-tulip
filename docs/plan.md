...
- [ ] **Next up:** Phase 1, continuing at P1.7 (spawn and session actions, built with UI specs), then P1.10b and P1.8. P1.1–P1.6 and P1.10a are done. See [native-client.md](./plans/native-client.md) for the full list
